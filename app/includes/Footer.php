<!-- ======================================= FOOTER ============= -->
<footer class="bg-teal-900 pt-8 mt-6">
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap text-left lg:text-left">
                <div class="w-full lg:w-6/12 px-4">
                    <h4 class="text-3xl font-bold text-white">DivoBlog</h4>
                ...
                <div class="w-full md:w-4/12 px-4 mx-auto text-center">
                    <div class="text-sm text-white font-semibold py-1">
                        Copyright © <span id="get-current-year">2023</span><a
                            ...
                            class="tegratext-gray-500er:tteatext-teal-700" target="_blank"> <b>DivoBlog By Taouil</b> 
                            <a href="https://www.creative-tim.com?ref=njs-profile" class ="gratext-gray-500
                                hover:text-teal-700">Hisenburg</a>.
                    </div>
                </div>
            </div>
        </div>
