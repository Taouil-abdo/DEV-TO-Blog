...
$rows = ArticlesController::getArticleBystatus();
session_start();
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-10">
            <?php foreach($rows as $row): ?>
             <div class="border-r border-b border-l border-gray-400 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
              ...
              <a href="../../view/pages/Article.php?id=<?= $row['id']?>">
               <img src="../../asset/uploads/Articles/<?php echo $row['featured_image']?>" alt="Image" class="w-full h-[16rem] mb-3">
                <div class="p-4 pt-2">
                  <div class="mb-8">
                  ...
                  <div class="flex items-center">
                    ...
                    <div class="text-sm">
                        <a href="#" class="text-gray-900 font-semibold leading-none hover:text-indigo-600"><?= $_SESSION['username'] ?>
                            </a>
