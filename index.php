    ...
    <main class="all">
        ...
        <div class="relative bg-gradient-to-r from-purple-600 to-blue-600 h-screen text-white overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-center items-center h-full text-center">
                ...
                <a href="#"
                    class="bg-teal-900 text-white hover:bg-yellow-300 py-2 px-6 rounded-full text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">Get
                    Started</a>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-10">
                ...
                <div
                    ...
                    <a href="app/view/pages/blog.php">
                        <img src="app/asset/uploads/Articles/<?php echo $row['featured_image']?>" alt="Player Image"
                        ...
                        <div class="p-4 pt-2">
                            <div class="mb-8">
                                ...
                                <p class="text-gray-700 text-sm"><?= $row['content'] ?> / Lorem ipsum dolor sit amet,
